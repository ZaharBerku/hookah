  ...
  return (
    <div className="flex border border-black rounded-2xl w-fit overflow-hidden">
      <Button
        ...
        color="transparent"
        rounded="none"
        className="before:block before:h-0.5 before:bg-black active:before:bg-white md:hover:before:bg-white before:w-2.5 md:before:w-3 active:bg-black md:hover:bg-black before:rounded-full flex-[20%] !h-8 px-2 py-1.5 md:px-3 md:py-2.5"
      />
      <Field
