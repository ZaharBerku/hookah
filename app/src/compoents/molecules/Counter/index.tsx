  ...
  return (
    ...
    >
      <Button
        ...
        color="transparent"
        rounded="none"
        className="before:block before:h-0.5 before:bg-white active:before:bg-black md:hover:before:bg-black before:w-2.5 md:before:w-3 active:!bg-white md:hover:!bg-white before:rounded-full flex-[20%] !h-8 md:!h-10 px-2 py-1.5 md:px-3 md:py-2.5 !bg-black"
      />
      <Field
        pattern={"[0-9]*"}
