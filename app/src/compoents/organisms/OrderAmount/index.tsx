...
const OrderAmount: FC = observer(() => {
  ...
  return (
    <div className="px-6 py-5 border-black border border-opacity-10 flex flex-col gap-6 justify-between rounded-3xl flex-[40%] max-h-96">
      <Typography tag="h3" text={"Сума замовлення"} />
      <ul className="flex flex-col w-full gap-5 border-b border-black border-opacity-10 pb-5">
        ...
        {Boolean(discount) && (
          <li className="flex justify-between items-center">
            <span className="text-3xs text-black text-opacity-60">Знижка</span>
        ...
        <li className="flex justify-between items-center">
          ...
          <span className="text-3xs font-bold text-black">За тарифами НП</span>
        </li>
      </ul>
